...
{
	[Activity(Label = "Xamarin ExoPlayer 2", MainLauncher = true, Icon = "@drawable/icon")]
	public class SampleChooserActivity : Activity, ExpandableListView.IOnChildClickListener
	{
		...
		private class SampleAdapter : BaseExpandableListAdapter
		{
				...
				View convertView, ViewGroup parent)
			{
				...
				if (view == null)
				{
					view = LayoutInflater.From(_context).Inflate(Android.Resource.Layout.SimpleListItem1, parent, false);
				}
			...
			public override View GetGroupView(int groupPosition, bool isExpanded, View convertView, ViewGroup parent)
			{
				...
				if (view == null)
				{
					view = LayoutInflater.From(_context).Inflate(Android.Resource.Layout.SimpleExpandableListItem1, parent, false);
				}
