...
public class FocusViewGestureDetector
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Camera.Droid.Renderers.FocusViewGestureDetector, Camera.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", FocusViewGestureDetector.class, __md_methods);
	}


	public FocusViewGestureDetector () throws java.lang.Throwable
	{
		super ();
		if (getClass () == FocusViewGestureDetector.class)
			mono.android.TypeManager.Activate ("Camera.Droid.Renderers.FocusViewGestureDetector, Camera.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
