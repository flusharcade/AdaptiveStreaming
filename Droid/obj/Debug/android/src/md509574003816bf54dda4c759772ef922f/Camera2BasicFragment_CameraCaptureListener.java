...
public class Camera2BasicFragment_CameraCaptureListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Camera.Droid.Renderers.CameraView.Camera2BasicFragment+CameraCaptureListener, Camera.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", Camera2BasicFragment_CameraCaptureListener.class, __md_methods);
	}


	public Camera2BasicFragment_CameraCaptureListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == Camera2BasicFragment_CameraCaptureListener.class)
			mono.android.TypeManager.Activate ("Camera.Droid.Renderers.CameraView.Camera2BasicFragment+CameraCaptureListener, Camera.Droid, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
